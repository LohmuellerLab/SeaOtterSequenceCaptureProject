...
modelName="2D.Bottleneck.noMigration"
...
def split_nomig_wBot(params, ns, pts):
    nu1,nu2,TDiv = params
    ...
    phi = Integration.two_pops(phi, xx, TDiv, nu1, nu2, m12=0, m21=0)  # two pops at diff sizes with symmetric migration
...
func=split_nomig_wBot # set the function
