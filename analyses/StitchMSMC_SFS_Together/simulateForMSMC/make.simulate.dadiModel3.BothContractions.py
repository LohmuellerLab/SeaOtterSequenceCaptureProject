...
nuCur = float(0.06) # keep at 0.06 which is what it was relative to 3500, even for higher Nanc here. It's the ratio that matters (0.06=195/3500 or 270/4500)
...
# theta = 4Namu = 4 (1/(lamba*2mu))*mu = 2/lamba
############################## WRITE SCRIPT ################
print("#!/bin/bash")
print("#$ -cwd")
